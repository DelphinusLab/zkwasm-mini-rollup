...
function async_get_leaf(root, index) {
    return __awaiter(this, void 0, void 0, function () {
        var requestData, response, jsonResponse;
...
function get_leaf(root, index) {
    async_get_leaf(root, index).then(function (value) { return value; });
}
...
function update_leaf(root, index, data) {
    async_update_leaf(root, index, data).then(function (value) { return value; });
}
