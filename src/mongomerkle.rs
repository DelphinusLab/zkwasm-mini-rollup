use crate::db;
use crate::db::{MongoDB, TreeDB};
use crate::merkle::{MerkleError, MerkleErrorCode, MerkleNode, MerkleProof, MerkleTree};
use crate::poseidon::MERKLE_HASHER;
cfg_if::cfg_if! {
    if #[cfg(feature="complex-leaf")] {
        use crate::poseidon::POSEIDON_HASHER as MERKLE_LEAF_HASHER;
    } else {
        use crate::poseidon::MERKLE_LEAF_HASHER;
    }
}
use ff::PrimeField;
...
mod tests {
    ...
    use crate::db::{get_collection_name, MONGODB_DATABASE, MONGODB_DATA_NAME_PREFIX};
    use crate::merkle::{MerkleNode, MerkleTree};
    use halo2_proofs::pairing::bn256::Fr;
    use halo2_proofs::arithmetic::BaseExt;
    use mongodb::bson::doc;

    // TODO: clag helper functions
    ...
    // TODO: clag helper functions
    fn field_to_bytes<F: BaseExt>(f: &F) -> [u8; 32] {
